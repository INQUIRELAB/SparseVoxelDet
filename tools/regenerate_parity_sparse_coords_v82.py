#!/usr/bin/env python3
"""
Regenerate sparse data from raw HDF5 events — 6-channel format.

Output per frame:
- coords: [N, 3] int16 (t_bin, y, x) at native 720x1280
...
Usage:
    python tools/regenerate_parity_sparse_coords_v82.py --dry-run
    python tools/regenerate_parity_sparse_coords_v82.py --workers 24
"""
...
TARGET_SIZE = (720, 1280)   # NATIVE — no spatial rescaling
...
def main():
    ...
    parser.add_argument(
        "--output-sparse-root",
        type=str,
        default="data/datasets/fred_paper_parity_v82/sparse",
        help="Output root for regenerated v82 sparse data.",
    )
    parser.add_argument(
        "--time-bins",
        type=int,
